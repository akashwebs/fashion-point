...
const DownloadApp = () => {
  return (
    <div className="lg:py-10 py-5">
      <div className="mid-container mx-auto mt-10 mb-10 rounded-lg bg-primary lg:p-14 sm:p-10 p-10">
        <div className="rounded-lg grid lg:grid-cols-3 bg-white">
          <div className="px-10 lg:col-span-2 lg:text-start text-center flex flex-col justify-center">
            ...
            <button className="mt-5 lg:mx-0 mx-auto btn btn-wide bg-primary text-xs text-white rounded-full">
              Download App
            </button>
          </div>
